...
engine = create_async_engine(
    ...
    echo=False,
    future=True,
    pool_size=getattr(settings, "DB_POOL_SIZE", 30),          # Base number of persistent connections
    max_overflow=getattr(settings, "DB_MAX_OVERFLOW", 20),       # Extra connections allowed beyond pool_size
