...
const menuItems = [
  ...
  { title: 'Relatório Igreja', icon: 'mdi-church', to: '/church-reports' },
  { title: 'Relatório Sistema', icon: 'mdi-earth', to: '/system-reports' },
...
const pageTitleMap = {
  ...
  '/church-reports': 'Relatório da Igreja',
  '/system-reports': 'Relatório Global do Sistema',
  '/qa-eval': 'Q&A Eval',
  '/chat': 'Chat IA',
  '/agents': 'Meus Agentes',
  '/disparador': 'Disparador',
  '/ingress': 'Entrada (Ingress)',
  '/egress': 'Saída (Egress)',
